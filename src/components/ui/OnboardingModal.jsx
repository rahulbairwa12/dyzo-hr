...
const OnboardingModal = ({
  initialOpen = false, // New prop to control initial visibility
  activeModal,
  onClose,
  noFade,
  disableBackdrop,
  ...
  const [showModal, setShowModal] = useState(initialOpen); // Initialize with initialOpen value
  ...
  useEffect(() => {
    setShowModal(initialOpen); // Update state if initialOpen changes
  }, [initialOpen]);
      ...
      {uncontrol ? (
        <Transition appear show={showModal} as={Fragment}>
          <Dialog
            ...
            onClose={!disableBackdrop ? closeModal : () => {}}
          >
            {!disableBackdrop && (
              <Transition.Child
                as={Fragment}
