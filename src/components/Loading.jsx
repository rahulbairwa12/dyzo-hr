...
import LogoWhite from "@/assets/images/common/app-icon-white.png";
import Logo from "@/assets/images/common/app-icon.webp";
...
const Loading = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center app_height">
      {!isAuth && (
        <div className="mb-3">
          <img src={isDark ? LogoWhite : Logo} alt="Logo" className="w-8 mx-auto" />
          <h3>Dyzo</h3>
        </div>
      )}
      <svg
