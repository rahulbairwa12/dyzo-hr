    ...
    Cell: (row) => {
      return (
        <span className="block w-full">
          <span
            className={` inline-block px-3 min-w-[90px] text-center mx-auto py-1 rounded-[999px] bg-opacity-25 ${row?.cell?.value
      ...
      return (
        <div className="flex space-x-3 rtl:space-x-reverse">
          <Tooltip content="View" placement="top" arrow animation="shift-away">
            <NavLink to={`/vacancy/${row?.cell?.value}`}>
...
const VacanciesListTable = ({ vacanciesList, title }) => {
  ...
  const data = useMemo(() => vacanciesList, []);
