        ...
        <div className="border rounded-lg p-4 my-4 space-y-4">
            ...
            {loading ? (
                ...
                <>
                    ...
                    {/* Attachment Viewer Replacement */}
                    {isAttachmentViewerOpen && screenshotsData[attachmentViewerIndex] && (
                        <Modal
                            title={`Screenshot ${moment(screenshotsData[attachmentViewerIndex].createdTime).format('DD/MM/YYYY HH:mm:ss')}`}
                            activeModal={isAttachmentViewerOpen}
                            onClose={handleAttachmentViewerClose}
                            className="max-w-5xl"
                        >
                            <div className="flex justify-center items-center bg-black-900 rounded-lg overflow-hidden">
                                <img
                                    src={screenshotsData[attachmentViewerIndex].url}
                                    alt="Screenshot"
