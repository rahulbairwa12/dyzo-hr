...
import { fetchContacts, fetchMessages, openChat } from "./store";
...
const ChatPage = () => {
  ...
  useEffect(() => {
    dispatch(fetchContacts({companyId:userInfo?.companyId, userId:userInfo?._id}));
  }, [dispatch]);

  const handleChatClick = (contact) => {
    dispatch(openChat({ activechat: true, contact }));
