...
const ClientProjectEditModal = ({ showEditProjectModal, setShowEditProjectModal, fetchProjects, data }) => {
    ...
    useEffect(() => {
        const fetchEmployeeList = async () => {
            try {
                ...
                // Filter only active employees and then map them to options
                const options = data
                    .filter(emp => emp.isActive)  // Filter employees with isActive set to true
                    .map((emp) => ({
                        value: emp._id,
                        label: emp.name,
            ...
            >
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 ">
                    ...
                    <Textinput
                            ...
                            value={userInfo?._id}
                            defaultValue={userInfo?.clientName}
...
export default ClientProjectEditModal;
